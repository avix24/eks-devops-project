...
# The VPC itself - your private network
...
# Elastic IP for NAT Gateway - a fixed public IP address
...
# NAT Gateway - lets private subnet reach internet, not the other way
...
# Route Table for Private Subnets - send internet traffic to NAT
